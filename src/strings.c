...
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. OLIVE's POKéDEX rating!\pPROF. OLIVE: Let's see…\p");
...
const u8 gText_OliveInTrouble[] = _("PROF. OLIVE is in trouble!\nRelease a POKéMON and rescue him!");
...
const u8 gText_SideQuestName_1[] = _("Dad's Chores");
const u8 gText_SideQuestDesc_1[] =_("Do your chores.");
const u8 gText_SideQuestDoneDesc_1[] = _("Proved to Dad he could be proud of you.");
const u8 gText_SideQuestMap1[] = _("Dad's Farm");

//subquests
const u8 gText_SubQuest1_Name1[] = _("Go Outside");
const u8 gText_SubQuest1_Desc1[] = _("Go outside to start.");
