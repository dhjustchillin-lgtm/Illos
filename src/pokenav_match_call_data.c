...
typedef union {
    ...
    const struct MatchCallOlive *olive;
...
static bool32 MatchCall_GetEnabled_Olive(match_call_t);
...
static mapsec_u8_t MatchCall_GetMapSec_Olive(match_call_t);
...
static bool32 MatchCall_IsRematchable_Olive(match_call_t);
...
static bool32 MatchCall_HasCheckPage_Olive(match_call_t);
...
static u32 MatchCall_GetRematchTableIdx_Olive(match_call_t);
...
static void MatchCall_GetMessage_Olive(match_call_t, u8 *);
...
static void MatchCall_GetNameAndDesc_Olive(match_call_t, const u8 **, const u8 **);
...
static const struct MatchCallOlive sProfOliveMatchCallHeader =
{
    .type = MC_TYPE_OLIVE,
    .mapSec = 0,
    .flag = FLAG_ENABLE_PROF_OLIVE_MATCH_CALL,
    .desc = COMPOUND_STRING("{PKMN} PROF."),
    .name = COMPOUND_STRING("PROF. OLIVE")
};
...
static const match_call_t sMatchCallHeaders[] = {
    ...
    [MC_HEADER_PROF_OLIVE] = {.olive  = &sProfOliveMatchCallHeader},
...
static u32 (*const sMatchCall_GetRematchTableIdxFunctions[])(match_call_t) = {
    ...
    MatchCall_GetRematchTableIdx_Olive
};
...
static void (*const sMatchCall_GetNameAndDescFunctions[])(match_call_t, const u8 **, const u8 **) = {
    ...
    MatchCall_GetNameAndDesc_Olive
};
...
static bool32 MatchCall_GetEnabled_Olive(match_call_t matchCall)
{
    return FlagGet(matchCall.olive->flag);
}
...
static mapsec_u8_t MatchCall_GetMapSec_Olive(match_call_t matchCall)
{
    return MAPSEC_NONE;
}
...
static bool32 MatchCall_IsRematchable_Olive(match_call_t matchCall)
{
    return FALSE;
}
...
static bool32 MatchCall_HasCheckPage_Olive(match_call_t matchCall)
{
    return FALSE;
}
...
static u32 MatchCall_GetRematchTableIdx_Olive(match_call_t matchCall)
{
    return REMATCH_TABLE_ENTRIES;
}
...
static void MatchCall_GetMessage_Olive(match_call_t matchCall, u8 *dest)
{
...
static void MatchCall_GetNameAndDesc_Olive(match_call_t matchCall, const u8 **desc, const u8 **name)
{
    *desc = matchCall.olive->desc;
    *name = matchCall.olive->name;
}
