...
const u16 gMetatiles_Test[] = INCBIN_U16("data/tilesets/secondary/farm/metatiles.bin");
const u16 gMetatileAttributes_Test[] = INCBIN_U16("data/tilesets/secondary/farm/metatile_attributes.bin");
